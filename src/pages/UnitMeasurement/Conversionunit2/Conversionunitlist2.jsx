...
const Conversionunitlist2 = () => {
  const navigate = useNavigate();
  const [searchTerm, setSearchTerm] = useState("");

  // Static data for conversion units (Measurement to Packaging)
  const conversionUnits = [
    {
      id: "CU2_001",
      conversion_name: "Weight to Package",
    ...
    {
      id: "CU2_002",
      conversion_name: "Volume to Package",
      from_measurementUnit_Name: "Liter",
      from_value: 1,
      to_packagingUnit_Name: "Bottle",
      to_value: 5,
    },
    {
      id: "CU2_003",
      conversion_name: "Length to Package",
      from_measurementUnit_Name: "Meter",
      from_value: 1,
      to_packagingUnit_Name: "Roll",
      to_value: 50,
    },
    {
      id: "CU2_004",
      conversion_name: "Small Weight to Package",
  ...
  const handleExcelDownload = () => {
    try {
      ...
      XLSX.writeFile(wb, "Conversion_Units_2.xlsx");
  ...
  const handleEdit = (id) => {
    navigate("/conversionunit2", { state: { id } });
  };
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Measurement Units" breadcrumbItem="All Conversion Unit" />
...
export default Conversionunitlist2;