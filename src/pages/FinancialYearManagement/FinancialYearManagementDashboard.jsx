...
const FinancialYearManagementDashboard = () => {
  const navigate = useNavigate();

  const dashboardData = [
    {
      title: "Financial Year Setup",
      route: "/financial-year-setup-list",
      icon: <FaIdCard />,
      color: "#007bff",
      count: "5",
    },
      ...
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            ...
            breadcrumbItem="Financial Year Management Dashboard"
          />
...
export default FinancialYearManagementDashboard;