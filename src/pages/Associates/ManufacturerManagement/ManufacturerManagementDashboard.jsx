...
import { FaIndustry, FaToggleOn, FaChartLine } from "react-icons/fa"; // Icons for each card
import Breadcrumbs from "../../../components/Common/Breadcrumb"; // Assuming this path is correct
import { useNavigate } from "react-router-dom";

const ManufacturerManagementDashboard = () => {
  ...
  const dashboardData = [
    {
      ...
      value: "30",
      description: "Total manufacturers registered",
      icon: <FaIndustry />,
      color: "#007bff",
    },
    {
      title: "Active vs Inactive Manufacturers",
      value: "25 / 5",
      description: "Active vs inactive count",
      icon: <FaToggleOn />,
      color: "#00c4cc",
    },
    {
      title: "Discount & Reorder Reports",
      value: "12",
      description: "Pending reorder reports",
      icon: <FaChartLine />,
      color: "#ff5722",
    },
  ];
              ...
              <Card className="shadow-lg" style={{ borderRadius: "20px", overflow: "hidden", background: "#f8f9fa" }}>
                <CardBody className="p-4">
                  <div className="d-flex justify-content-between align-items-center mb-4">
                    ...
                    >
                      Manufacturer Management Dashboard
                    </h4>
                    <Button
                      color="secondary"
                      onClick={handleBack}
...
export default ManufacturerManagementDashboard;