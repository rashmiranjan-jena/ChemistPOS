...
const ManufacturerManagementCart = () => {
  const navigate = useNavigate();

  // Card data structure with routes and unique colors
  const cards = [
    {
      title: "Manufacturer Details",
      route: "/manufacturer-details-form",
      backgroundGradient: "linear-gradient(135deg, #f3e8ff, #d8b4fe)", 
      topGradient: "linear-gradient(90deg, #8b5cf6, #6d28d9)", 
      arrowColor: "#6d28d9", 
    },
...
export default ManufacturerManagementCart;