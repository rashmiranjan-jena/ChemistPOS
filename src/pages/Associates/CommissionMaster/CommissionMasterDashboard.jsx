...
import { FaMoneyBillWave, FaUserMd } from "react-icons/fa"; // Icons for each card
import Breadcrumbs from "../../../components/Common/Breadcrumb"; // Assuming this path is correct
import { useNavigate } from "react-router-dom";

const CommissionMasterDashboard = () => {
  ...
  const dashboardData = [
    ...
    {
      title: "Doctor Wise Commission Tracking",
      value: "8",
      description: "Doctors tracked this month",
      icon: <FaUserMd />,
      color: "#00c4cc",
    },
  ];
      ...
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            ...
            breadcrumbItem="Commission Dashboard"
          />
