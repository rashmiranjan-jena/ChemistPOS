...
const SupplierManagementCart = () => {
  const navigate = useNavigate();

  const cards = [
    {
      title: "Supplier Details",
      route: "/supplier-management-reports",
      backgroundGradient: "linear-gradient(135deg, #f0fdfa, #ccfbf1)", 
      topGradient: "linear-gradient(90deg, #14b8a6, #0d9488)",
      arrowColor: "#0d9488",
    },
  ];
      ...
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            ...
            breadcrumbItem="Supplier Details"
          />
...
export default SupplierManagementCart;