...
import { FaUsers, FaCalendarCheck, FaMoneyCheckAlt } from "react-icons/fa"; // Icons for each report
import Breadcrumbs from "../../../components/Common/Breadcrumb"; // Assuming this path is correct
import { useNavigate } from "react-router-dom";

const AddNewEmployeeReport = () => {
  ...
  const reports = [
    {
      title: "Employee List",
      description: "Filter: Department, Store, DOJ, DOL, Salary Range",
      route: "/employee-list-report",
      icon: <FaUsers />,
      color: "#007bff",
    },
    {
      title: "Attendance & Leave Report",
      description: "Attendance and leave details",
      route: "/attendance-leave-report",
      icon: <FaCalendarCheck />,
      color: "#00c4cc",
    },
    {
      title: "Payroll Summary",
      description: "Summary of payroll data",
      route: "/payroll-summary-report",
      ...
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            ...
            breadcrumbItem="Employee Reports"
          />
...
export default AddNewEmployeeReport;