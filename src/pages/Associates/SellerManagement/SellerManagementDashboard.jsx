...
import { FaChartBar, FaBalanceScale, FaUndo } from "react-icons/fa"; // Icons for each card
...
const SellerManagementDashboard = () => {
  ...
  const dashboardData = [
    ...
    {
      title: "Credit vs Payment Status",
      value: "$2,300 / $1,800",
      description: "Credit vs paid amount",
      icon: <FaBalanceScale />,
      color: "#00c4cc",
    },
    {
      ...
      value: "15",
      description: "Total returns this month",
      icon: <FaUndo />,
      color: "#ff5722",
    },
  ];
