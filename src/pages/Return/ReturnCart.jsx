...
const ReturnCart = () => {
  ...
  const dashboardData = [
    { title: "Return Product", route: "/product-return", icon: <FaFileAlt />, color: "#007bff", count: "12" },
    { title: "Return Memo", route: "/return-memo", icon: <FaIdCard />, color: "#00c4cc", count: "8" },
    { title: "Return Bill", route: "/return-bill", icon: <FaFileAlt />, color: "#f44336", count: "18" },
    { title: "Return Adjustment", route: "/return-adjustment", icon: <FaIdCard />, color: "#ff9800", count: "5" },
  ];
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Return" breadcrumbItem="Dashboard" />
                      ...
                      <Col xs="12" sm="6" lg="4" xl="3" key={index}>
                        ...
                        >
                          <CardBody className="p-3 text-center">
                            <div style={{ fontSize: "40px", color: item.color, marginBottom: "15px" }}>
                              {item.icon}
                            </div>
                            <CardTitle
                              tag="h5"
