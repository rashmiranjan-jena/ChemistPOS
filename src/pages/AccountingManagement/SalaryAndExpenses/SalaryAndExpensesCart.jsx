...
const SalaryAndExpensesCart = () => { 
  const navigate = useNavigate();

  // Card data structure with routes
  const cards = [
    { title: "Salary Management", route: "/salary-list" },
    { title: "Expense Management", route: "/expense-list" },
  ];
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            title="Finance"
            breadcrumbItem="Salary & Expenses"
          />
...
export default SalaryAndExpensesCart;