...
const CustomerLedger = () => {
  ...
  // Static data for customer ledger records
  const staticData = [
    {
      id: 1,
      date: "2025-04-01",
    ...
    },
    {
      ...
      debit: 0,
      credit: 50000,
      balance: 68000, // previous balance + debit - credit
    },
    {
      id: 3,
      date: "2025-04-05",
      invoice: "INV003",
      description: "Sale of Monitor",
      debit: 70800,
      credit: 0,
      balance: 138800, // previous balance + debit - credit
    },
  ];
  ...
  const handleEdit = (id) => {
    navigate("/ledger-form", { state: { id } }); // Adjust route as needed
  };
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Accounting Management" breadcrumbItem="Customer Ledger" />
