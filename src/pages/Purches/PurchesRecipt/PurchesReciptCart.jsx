...
const PurchesReciptCart = () => {
  const navigate = useNavigate();

  const cards = [
    { title: "Purches Recipt", route: "/purchase-receipt-form" },
  ];
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            title="Purchase Receipt  Management"
            breadcrumbItem="Add Purchase Receipt "
          />
...
export default PurchesReciptCart;