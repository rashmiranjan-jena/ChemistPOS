...
const PurchaseEntryCart = () => { 
  const navigate = useNavigate(); 

  // Card data structure with routes
  const cards = [
    { title: "Purches entry", route: "/purchase-entry-form" },
  ];
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            title="Purches Entry Management"
            breadcrumbItem="Add Purches Entry"
          />
...
export default PurchaseEntryCart; 