...
import { FaFileAlt, FaIdCard, FaEye } from "react-icons/fa"; // Updated icons
...
const AdminModule = () => {
  ...
  const dashboardData = [
    { title: "KYC Management", route: "/kyc-management-list", icon: <FaIdCard />, color: "#007bff", count: "200" },
    { title: "Document Master", route: "/document-master-list", icon: <FaFileAlt />, color: "#00c4cc", count: "150" },
  ];
