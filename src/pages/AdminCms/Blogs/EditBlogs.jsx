...
const EditBlogs = () => {
        ...
        try {
          ...
          if (response) {
            ...
            setInitialValues({
              ...
              socialName: socialLinks.socialName || "",
              socialLink: socialLinks.socialLink || "",
              bannerImage: null, // Set to null initially
              displayImage: null, // Set to null initially
              authorImage: null, // Set to null initially
            });
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      if (values.displayImage instanceof File) {
      ...
      try {
        ...
        Swal.fire({
          icon: "success",
          title: id ? "Blog Updated Successfully!" : "Blog Created Successfully!",
          text: "Your blog has been Updated.",
          confirmButtonText: "OK",
        });
  ...
  const handleFileChange = (event, fieldName) => {
    ...
    if (file) {
      formik.setFieldValue(fieldName, file); // ✅ Save file object directly
