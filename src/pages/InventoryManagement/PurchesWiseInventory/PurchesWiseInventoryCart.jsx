...
const PurchesWiseInventoryCart = () => {
  const navigate = useNavigate();
  const cards = [
    { title: "Purches Wise Details", route: "/purchase-wise-inventory-form" },
  ];
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            title="Purches Wise Management"
            breadcrumbItem="Add Purches Wise "
          />
...
export default PurchesWiseInventoryCart;