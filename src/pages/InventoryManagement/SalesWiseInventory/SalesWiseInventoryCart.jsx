...
const SalesWiseInventoryCart = () => {
  const navigate = useNavigate();
  const cards = [
    { title: "Sales Wise Details", route: "/sales-wise-inventory-form" },
  ];
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            title="Sales Wise Management"
            breadcrumbItem="Add Sales Wise "
          />
...
export default SalesWiseInventoryCart;