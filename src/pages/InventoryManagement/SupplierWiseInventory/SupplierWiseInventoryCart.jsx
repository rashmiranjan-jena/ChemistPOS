...
const SupplierWiseInventoryCart = () => {
  const navigate = useNavigate();

  // Card data structure with routes
  const cards = [
    { title: "Supplier Wise Inventory Details", route: "/supplier-wise-inventory-form" },
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            title="Supplier Wise Inventory Management"
            breadcrumbItem="Add Supplier Wise Inventory"
          />
...
export default SupplierWiseInventoryCart;