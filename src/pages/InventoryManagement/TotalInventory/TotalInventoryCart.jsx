...
const TotalInventoryCart = () => {
  const navigate = useNavigate();

  // Card data structure with routes
  const cards = [
    { title: "Total Inventory Details", route: "/total-inventory-form" },
  ];
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            title="Total Inventory Management"
            breadcrumbItem="Add Total Inventory"
          />
...
export default TotalInventoryCart;