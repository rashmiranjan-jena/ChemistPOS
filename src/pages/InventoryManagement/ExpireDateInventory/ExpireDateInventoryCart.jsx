...
const ExpireDateInventoryCart = () => {
  const navigate = useNavigate();

  // Card data structure with routes
  const cards = [
    { title: "Expire Date Inventory", route: "/expire-date-inventory-form" },
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            title="Expire Date Inventory Management"
            breadcrumbItem="Add Expire Date Inventory"
          />
...
export default ExpireDateInventoryCart;