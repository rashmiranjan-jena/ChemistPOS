...
const GroupDiseaseCart = () => {
  const navigate = useNavigate();

  const cards = [
    { title: "Group Disease", route: "/group-disease-form" },
  ];
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            title="Group Disease Management"
            breadcrumbItem="Add New Group Disease"
          />
...
export default GroupDiseaseCart;