...
const ProductTypeCart = () => {
  const navigate = useNavigate();

  const cards = [{ title: "Product Type", route: "/product-type-form" }];
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            title="ProductType Management"
            breadcrumbItem="Add New Product Type"
          />
...
export default ProductTypeCart;
