...
const CategoryList = () => {
  ...
  const handleEdit = (id) => {
    navigate(`/category-form`, { state: { id } });
  };
    ...
    if (firstConfirmation?.isConfirmed) {
      ...
      if (secondConfirmation?.isConfirmed) {
        try {
          ...
          Swal.fire({
            title: "Error!",
            text: error?.message ?? "Failed to delete the category.",
            icon: "error",
            confirmButtonText: "OK",
          });
        }
  ...
  const handleExcelUpload = async (event) => {
    ...
    if (file) {
      ...
      try {
        const response = await uploadCategoriesExcel(formData);
        Swal.fire({
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Drugs" breadcrumbItem="Category List" />
